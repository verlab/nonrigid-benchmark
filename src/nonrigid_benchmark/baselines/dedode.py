...
def parse():
    ...
    parser.add_argument("--output",  "-o", type=str, default="./results/DeDoDe_g_2048", help="Name of the model to save the predictions")
    return parser.parse_args()

if __name__ == "__main__":
    args = parse()
    
    extractor = DeDoDe_baseline(top_kps=2048, device=0)
